...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		aspectRatio:        1.6,          /* Aspect ratio of the ImageFlow container (width divided by height) */
		...
		ImageFlowID:        'crbpflow',    /* Default id of the ImageFlow container */
...
domReady(function()
{
	...
	instanceOne.init({ ImageFlowID:'crbpflow' });
});